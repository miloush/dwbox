...
[assembly: AssemblyCopyright("Copyright © Jan Kučera 2022-2026")]
...
// 3.0.0.0 vertical text, vector rendering, stacked orientation, tooltip to box header, parallel run/cluster/glyph highlight on hover, more highlight colors, open file dialog, glyph run details: use geometry from DWrite, context menu to toolbar, run index and grouping, glyph origins
