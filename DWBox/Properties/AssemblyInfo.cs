...
[assembly: AssemblyCopyright("Copyright © Jan Kučera 2022-2025")]
...
// 3.0.0.0 vertical text, vector rendering, stacked orientation, tooltip to box header, parallel run/cluster/glyph highlight on hover, glyph run details: use geometry from DWrite, context menu to toolbar, run index and grouping, glyph origins
